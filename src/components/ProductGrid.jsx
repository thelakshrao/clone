  ...
  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 sm:gap-5">
    {shuffledProducts.map((item) => (
      <div
        ...
        className="cursor-pointer bg-white hover:shadow-lg transition-all duration-200 p-3 rounded-xl border border-gray-200 hover:border-gray-300"
      >
        ...
        <div className="mt-2 justify-center">
          <h3 className="font-semibold text-gray-900 text-sm sm:text-base text-center mt-2 truncate w-full">
            {item.name}
          </h3>
          ...
          <div className="flex items-center gap-10 mt-1 justify-center">
